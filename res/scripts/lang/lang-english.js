...
$.lang.data["net.phantombot.init.coolcom-help"] = "Usage: \"!coolcom seconds\" sets the global cooldown, set to 0 to disable. \"!coolcom command seconds\" overrides global coolcom on the named command, 0 to disable on that command or -1 to use the global value. \"!coolcom command get\" to get a commands coolcom. \"!coolcomuser\" toggles applying cooldowns to users instead of commands";
$.lang.data["net.phantombot.init.coolcom-usermode-enable"] = "Cooldowns are now applied to users rather than commands";
$.lang.data["net.phantombot.init.coolcom-usermode-disable"] = "Cooldowns are now applied to commands rather than users";
$.lang.data["net.phantombot.init.reconn"] = "A reconnect has been requested!";
