...
//killCommand.js 
$.lang.data["net.phantombot.kilcommand.error-no-kills"] = "There are no kill messages at this time";
$.lang.data["net.phantombot.kilcommand.num-kills"] = "There are only $1 kills right now! Remember that kill messages are numbered from 0 to $2!";
$.lang.data["net.phantombot.kilcommand.addkill-usage"] = "Usage: !addkill (message)";
$.lang.data["net.phantombot.kilcommand.kill-added"] = "kill message added! There are now $1 kill messages!";
$.lang.data["net.phantombot.kilcommand.error-wrong-id"] = "There are $1 kill messages. Message IDs go from 0 to $2 and $3 isn't one of them";
$.lang.data["net.phantombot.kilcommand.edit-kill-usage"] = "Usage: !editkill (id) (message)";
$.lang.data["net.phantombot.kilcommand.kill-edited"] = "kill message #$1 changed to: $2";
$.lang.data["net.phantombot.kilcommand.del-kill-usage"] = "Usage: !delkill (ID)";
$.lang.data["net.phantombot.kilcommand.del-kill-success"] = "kill removed! There are now $1 kills!";
$.lang.data["net.phantombot.kilcommand.self-kill-1"] = "$1 has somehow managed to kill himself. ";
$.lang.data["net.phantombot.kilcommand.self-kill-2"] = "$1 died from unknown causes.";
$.lang.data["net.phantombot.kilcommand.self-kill-3"] = "$1 was sliced in half by Boulder (or something along those lines).";
$.lang.data["net.phantombot.kilcommand.self-kill-4"] = "$1 exploded.";
$.lang.data["net.phantombot.kilcommand.self-kill-5"] = "$1 forgot how to breathe.";
$.lang.data["net.phantombot.kilcommand.self-kill-6"] = "$1 learned that cellular respiration uses oxygen, not sand.";
$.lang.data["net.phantombot.kilcommand.self-kill-7"] = "$1 died.";
$.lang.data["net.phantombot.kilcommand.self-kill-8"] = "$1 tried to befriend a wild grizzly bear.";
$.lang.data["net.phantombot.kilcommand.self-kill-9"] = "$1 suffocated.";
$.lang.data["net.phantombot.kilcommand.self-kill-10"] = "$1 tested the bounds of time and space and lost.";
$.lang.data["net.phantombot.kilcommand.self-kill-11"] = "$1 ixploded.";
$.lang.data["net.phantombot.kilcommand.self-kill-12"] = "$1 drowned.";
$.lang.data["net.phantombot.kilcommand.self-kill-13"] = "$1 ceased to be.";
$.lang.data["net.phantombot.kilcommand.self-kill-14"] = "$1 went kablewy!";
$.lang.data["net.phantombot.kilcommand.self-kill-15"] = "$1 figured out how to divide by 0!";
$.lang.data["net.phantombot.kilcommand.self-kill-16"] = "$1 took a long walk off a short pier.";
$.lang.data["net.phantombot.kilcommand.self-kill-17"] = "$1 fell off a ladder.";
$.lang.data["net.phantombot.kilcommand.self-kill-18"] = "$1 fell off a tree.";
$.lang.data["net.phantombot.kilcommand.self-kill-19"] = "$1 fell off himself.";
$.lang.data["net.phantombot.kilcommand.self-kill-20"] = "$1 bursts into flames.";
$.lang.data["net.phantombot.kilcommand.self-kill-21"] = "$1 was struck by lightening.";
$.lang.data["net.phantombot.kilcommand.self-kill-22"] = "$1 starved to death.";
$.lang.data["net.phantombot.kilcommand.self-kill-23"] = "$1 was stabbed to death by (random).";
$.lang.data["net.phantombot.kilcommand.self-kill-24"] = "$1 fell victim to gravity.";
$.lang.data["net.phantombot.kilcommand.self-kill-25"] = "$1 's plead for death was answered.";
$.lang.data["net.phantombot.kilcommand.self-kill-26"] = "$1 's vital organs were ruptured.";
$.lang.data["net.phantombot.kilcommand.self-kill-27"] = "$1 's innards were made outwards.";
$.lang.data["net.phantombot.kilcommand.self-kill-28"] = "$1 was licked to death. Don't ask.";
$.lang.data["net.phantombot.kilcommand.self-kill-29"] = "$1 was deleted.";
$.lang.data["net.phantombot.kilcommand.self-kill-30"] = "$1 had to split.";
$.lang.data["net.phantombot.kilcommand.self-kill-31"] = "$1 Food is a gift from God. Spices are a gift from the devil. I guess it was a little too spicy for you.";
$.lang.data["net.phantombot.kilcommand.kill-1"] = "(sender) murdered (1) with a unicorn's horn!";
$.lang.data["net.phantombot.kilcommand.kill-2"] = "(1) was killed by a (sender)!";
$.lang.data["net.phantombot.kilcommand.kill-3"] = "(1) was mauled by (sender) dressed up as a chicken.";
$.lang.data["net.phantombot.kilcommand.kill-4"] = "(1) was ripped apart by (sender), Daaaaaaamn!";
$.lang.data["net.phantombot.kilcommand.kill-5"] = "(1) was brutally murdered by (sender) with a car!";
$.lang.data["net.phantombot.kilcommand.kill-6"] = "(sender) covered (1) in meat sauce and threw them in a cage with a starved tiger.";
$.lang.data["net.phantombot.kilcommand.kill-7"] = "(sender) genetically modified a Venus flytrap so it grows really big and trapped (1) in a room with it.";
$.lang.data["net.phantombot.kilcommand.kill-8"] = "(sender) shanked (1)'s butt, over and over again.";
$.lang.data["net.phantombot.kilcommand.kill-9"] = "(sender) just wrote (1)'s name in their Death Note.";
$.lang.data["net.phantombot.kilcommand.kill-10"] = "(sender) put (1) out of their misery.";
$.lang.data["net.phantombot.kilcommand.kill-11"] = "(sender) destroyed (1)!";
$.lang.data["net.phantombot.kilcommand.kill-12"] = "(sender) atacó a (1) con un consolador grande!";
$.lang.data["net.phantombot.kilcommand.kill-13"] = "(1) was poked a bit too hard by (sender) with a spoon!";
$.lang.data["net.phantombot.kilcommand.kill-14"] = "(sender) got his hands on a steamroller and steam rolled (1) flat! So, yeah (1) did die from that.";
$.lang.data["net.phantombot.kilcommand.kill-15"] = "(sender) attacked (1) with a rusty spoon as the weapon...and managed to (1) with very little effort.";
$.lang.data["net.phantombot.kilcommand.kill-16"] = "(sender) stole a car known as 'KITT' and ran over (1).";
$.lang.data["net.phantombot.kilcommand.kill-17"] = "(sender) tickled (1) to death!";
$.lang.data["net.phantombot.kilcommand.kill-18"] = "(1)'s skull was crushed by (sender)!";
$.lang.data["net.phantombot.kilcommand.kill-19"] = "(1) is in several pieces after a tragic accident involving (sender) and spoons.";
$.lang.data["net.phantombot.kilcommand.kill-20"] = "(sender) licked (1) until (sender) was squishy, yeah.. squishy.";
$.lang.data["net.phantombot.kilcommand.kill-21"] = "(sender) catapulted a huge load of rusty spoons on to (1). (1) died.";
$.lang.data["net.phantombot.kilcommand.kill-22"] = "(sender) ran out of rusty spoons and unicorn horns to kill (1) with and so instead used a rusty hanger.";
$.lang.data["net.phantombot.kilcommand.kill-23"] = "(sender) came in like a mystical being of awesomeness and destroyed (1)!";
$.lang.data["net.phantombot.kilcommand.kill-24"] = "(1) drowned whilst trying to escape from (sender)";
$.lang.data["net.phantombot.kilcommand.kill-25"] = "(1) walked into a cactus while trying to escape from (sender)";
$.lang.data["net.phantombot.kilcommand.kill-26"] = "(1) was attacked by (sender) behind a Taco Bell restaurant.";
$.lang.data["net.phantombot.kilcommand.kill-27"] = "(sender) went back in time to prevent himself from killing (1), apparently the time machine landed (1) when (sender) jumped back in time.";
...
$.lang.data["net.phantombot.bankheistsystem.already-beted"] = "you have already placed a bet of ";
...
$.lang.data["net.phantombot.bankheistsystem.max-allowed"] = "The maximum amount allowed is ";
...
$.lang.data["net.phantombot.bankheistsystem.new-value-for-enterABet"] = "The value for enterABet has been set to ";
