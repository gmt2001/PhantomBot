        ...
        if (args.length === 0 && $.moduleEnabled("./systems/pointSystem.js")) {
            ...
            if (symbol1 == symbol2 && symbol2 == symbol3) {
                ...
                if (symbol1 == $.slotEmote1) {
                    $.say(symbol1  + " \u2726 " + symbol2 + " \u2726 " + symbol3 + " " + username + " won " + $.slotEmoteReward1 * $.slotBonus + " " + $.getPointsString($.slotEmoteReward1 * $.slotBonus) + "!" + " " + s);
                    $.inidb.incr('points', sender, ($.slotEmoteReward1) * $.slotBonus);
                }
                if (symbol1 == $.slotEmote2) {
                    $.say(symbol1  + " \u2726 " + symbol2 + " \u2726 " + symbol3 + " " + username + " won " + $.slotEmoteReward2 * $.slotBonus + " " + $.getPointsString($.slotEmoteReward2 * $.slotBonus) + "!" + " " + s);
                    $.inidb.incr('points', sender, ($.slotEmoteReward2) * $.slotBonus);
                }
                if (symbol1 == $.slotEmote3) {
                    $.say(symbol1  + " \u2726 " + symbol2 + " \u2726 " + symbol3 + " " + " won " + $.slotEmoteReward3 * $.slotBonus + " " + $.getPointsString($.slotEmoteReward3 * $.slotBonus) + "!" + " " + s);
                    $.inidb.incr('points', sender, ($.slotEmoteReward3) * $.slotBonus);
                }
                if (symbol1 == $.slotEmote4) {
                    $.say(symbol1  + " \u2726 " + symbol2 + " \u2726 " + symbol3 + " " + username + " won " + $.slotEmoteReward4 * $.slotBonus + " " + $.getPointsString($.slotEmoteReward4 * $.slotBonus) + "!" + " " + s);
                    $.inidb.incr('points', sender, ($.slotEmoteReward4) * $.slotBonus);
                }
                if (symbol1 == $.slotEmote5) {
                    $.say(symbol1  + " \u2726 " + symbol2 + " \u2726 " + symbol3 + " " + username + " won " + $.slotEmoteReward5 * $.slotBonus + " " + $.getPointsString($.slotEmoteReward5 * $.slotBonus) + "!" + " " + s);
                    $.inidb.incr('points', sender, ($.slotEmoteReward5) * $.slotBonus);
                }
                if (symbol1 == $.slotEmote6) {
                    $.say(symbol1  + " \u2726 " + symbol2 + " \u2726 " + symbol3 + " " + username + " won " + $.slotEmoteReward6 * $.slotBonus + " " + $.getPointsString($.slotEmoteReward6 * $.slotBonus) + "!" + " " + s);
                    $.inidb.incr('points', sender, ($.slotEmoteReward6) * $.slotBonus);
                }
                if (symbol1 == $.slotEmote7) {
                    $.say(symbol1  + " \u2726 " + symbol2 + " \u2726 " + symbol3 + " " + "JACKPOT! " + username + " won " + $.slotJackpot  * $.slotBonus + " " + $.getPointsString($.slotJackpot * $.slotBonus) + "!" + " " + " points!");
                ...
                $.say(symbol1  + " \u2726 " + symbol2 + " \u2726 " + symbol3 + " " + username + " saw a " + $.slotEmote7 + "! Here's " + $.slotSeeingEmoteReward7 * $.slotBonus + " " + $.getPointsString($.slotSeeingEmoteReward7 * $.slotBonus) + "!" + " " + s);
                ...
                if ((symbol1 == symbol2 && symbol1 == $.slotEmote7 && $.slotHalfRewards == 1) || (symbol1 == symbol3 && symbol1 == $.slotEmote7 && $.slotHalfRewards == 1) || (symbol3 == symbol2 && symbol3 == $.slotEmote7 && $.slotHalfRewards == 1)) {
                    $.say(symbol1 + " \u2726 " + symbol2 + " \u2726 " + symbol3 + " " + username + " kind of won! Here's  " + $.slotDoubleEmoteReward7 * $.slotBonus + " " + $.getPointsString($.slotDoubleEmoteReward7 * $.slotBonus) + "!" + " " + s);
                ...
                $.say(symbol1  + " \u2726 " + symbol2 + " \u2726 " + symbol3 + " " + username + " kind of won! Here's " + $.slotDoubleEmoteReward6 * $.slotBonus + " " + $.$.getPointsString($.slotDoubleEmoteReward6 * $.slotBonus) + "!" + " " + s);
                ...
                $.say(symbol1  + " \u2726 " + symbol2 + " \u2726 " + symbol3 + " " + username + " kind of won! Here's " + $.slotDoubleEmoteReward5 * $.slotBonus + " " + $.getPointsString($.slotSeeingEmoteReward5 * $.slotBonus) + "!" + " " + s);
                ...
                $.say(symbol1  + " \u2726 " + symbol2 + " \u2726 " + symbol3 + " " + username + " kind of won! Here's " + $.slotDoubleEmoteReward4 * $.slotBonus + " " + $.getPointsString($.slotSeeingEmoteReward4 * $.slotBonus) + "!" + " " + s);
                ...
                $.say(symbol1  + " \u2726 " + symbol2 + " \u2726 " + symbol3 + " " + username + " kind of won! Here's " + $.slotDoubleEmoteReward3 * $.slotBonus + " " + $.getPointsString($.slotDoubleEmoteReward3 * $.slotBonus) + "!" + " " + s);
